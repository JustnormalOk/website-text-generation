...
3. **Install Models**: If the PC or laptop is 16GB max, install a lightweight model, any model you like to
4. **Install Python Packages**: Install by this command in terminal or command prompt: `pip3 install flask requests`
